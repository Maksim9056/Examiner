...
public partial class DocTestsFromQuestions : ContentPage
{
    ...
    public DocTestsFromQuestions(ExamModels.Exams exams, ExamModels.User currrentUser)
    {
...
#pragma warning restore CS0618 // Тип или член устарел
    ...
    private List<RefExamsTest> GetExamsTest(ExamModels.Exams exams, ExamModels.User currrentUser)  
    {
