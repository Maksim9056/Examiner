...
namespace Client.Project
{
    public partial class DocExamTestListPage : ContentPage
    {
        ...
        public DocExamTestListPage(ExamModels.Exams exams)
        {
            InitializeComponent();
...
#pragma warning restore CS0618 // Тип или член устарел
        ...
        private void UpdateForm(ExamModels.Exams exams)
        {
            TestList.ItemsSource = GetExamsTest(exams);
        }
        ...
        private List<RefExamsTest> GetExamsTest(ExamModels.Exams exams)
        {
        ...
        private async void OnItemSelected(object sender, SelectedItemChangedEventArgs e)
        {
            ...
            await DisplayAlert(AppResources.Выбранныйтест, selectedExamsTest.ExamsTest.Exams.Name_exam, AppResources.Ок);
        ...
        private void Del(object examsTest)
        {
            ...
            DisplayAlert(AppResources.Удаляетсятест, selectedExamsTest.ExamsTest.Exams.Name_exam, AppResources.Ок);
