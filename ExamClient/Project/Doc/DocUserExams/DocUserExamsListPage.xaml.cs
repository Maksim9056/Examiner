...
namespace Client.Project
{
    public partial class DocUserExamsListPage : ContentPage
    {
        ...
        public DocUserExamsListPage(ExamModels.User user)
        {
            InitializeComponent();
            ...
            Title =   AppResources.Ёкзаменыдл€пользовател€ + user.Name_Employee;
...
#pragma warning restore CS0618 // “ип или член устарел
        ...
        private void UpdateForm(ExamModels.User user)
        {
            ExamsList.ItemsSource = GetUserExams(user);
        }
        ...
        private List<RefUserExams> GetUserExams(ExamModels.User user)
        {
        ...
        private async void OnItemSelected(object sender, SelectedItemChangedEventArgs e)
        {
            ...
            await DisplayAlert(AppResources.¬ыбранныйэкзамен , selectedUserExams.UserExams.Exams.Name_exam, AppResources.ќк);
        ...
        private void Del(object userExams)
        {
            ...
            DisplayAlert(AppResources.”дал€етс€ответ, selectedUserExams.UserExams.Exams.Name_exam, AppResources.ќк);
        ...
        private async void CreateButtonClicked(object sender, EventArgs e)
        {
            ...
            refExamsListPage.Mode = 1; // «десь вы можете указать нужный режим
